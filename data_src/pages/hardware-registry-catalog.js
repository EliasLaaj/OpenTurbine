...
const REGISTRY_INPUT_PURPOSES=[
  ...
  {value:'p1_pressure',label:'Compressor inlet pressure (P1)',role:'pressure',drivers:[1,9],group:'Engine sensors'},
  {value:'p2_pressure',label:'Compressor discharge pressure (P2)',role:'pressure',drivers:[1,9],group:'Engine sensors'},
